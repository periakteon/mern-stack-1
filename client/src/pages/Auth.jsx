  ...
  return (
    <div className='w-full h-screen bg-gray-100 flex items-center justify-center fixed top-0 right-0 bottom-0 left-0 z-50'>
      <div className='w-1/3 bg-white rounded-md p-3'>
        ...
        <div>
          <button className='cursor-pointer hover:bg-indigo-800 active:bg-indigo-500 w-full p-2 text-center bg-indigo-600 text-white rounded-md'>{signUp ? 'Kayıt Ol' : 'Giriş Yap'}</button>
        </div>
      </div>
    </div>
  );
